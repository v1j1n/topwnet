                        ...
                        <div class="col-lg-6">
                            <div class="input-feild">
                                <select name="service_name" id="subject" required>
                                    ...
                                    <option value="IT Consulting" {{ old('service_name') == 'IT Consulting' ? 'selected' : '' }}>IT Consulting</option>
                                    <option value="Network Security" {{ old('service_name') == 'Network Security' ? 'selected' : '' }}>Network Security</option>
                                    <option value="IT Outsourcing" {{ old('service_name') == 'IT Outsourcing' ? 'selected' : '' }}>IT Outsourcing</option>
                                    <option value="Hardware & Software" {{ old('service_name') == 'Hardware & Software' ? 'selected' : '' }}>Hardware & Software Solutions</option>
                                    <option value="AMC" {{ old('service_name') == 'AMC' ? 'selected' : '' }}>Annual Maintenance Contract</option>
                                    <option value="Web Development" {{ old('service_name') == 'Web Development' ? 'selected' : '' }}>Website Development</option>
                                    <option value="Domain & Hosting" {{ old('service_name') == 'Domain & Hosting' ? 'selected' : '' }}>Domain & Hosting</option>
                                    <option value="Other" {{ old('service_name') == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn-one mt-4 mx-auto" data-animation="fadeInUp" data-delay=".8s">Submit <i class="fa-solid fa-angle-right ms-2"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                // Show success message below submit button
            ...
            if (error.response) {
                error.response.json().then(errorData => {
                    ...
                    if (errorData.errors) {
                        ...
                        showMessage('danger', 'Please fix the following errors:', errors);
                    } else {
                        showMessage('danger', errorData.message || 'An error occurred. Please try again.');
                    }
                });
            } else {
                // Network or other errors
                removeErrorMessages();
                showMessage('danger', 'An error occurred. Please check your connection and try again.');
            }
        })
        .finally(() => {
    ...
    // Helper function to show messages below submit button
    function showMessage(type, message, errors = []) {
        ...
        const submitBtnContainer = submitBtn.closest('.text-center');
    ...
    // Helper function to remove existing error/success messages

...
<section class="banner-section">
    ...
    <div class="swiper banner-slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="slide-bg" data-background="{{ asset('images/banner/it-solutions.jpg') }}"></div>
                <div class="container">
                    <div class="outer-box">
                        <div class="row g-0 align-items-end">
                            <div class="col-lg-8 content-column">
                                <div class="inner-column">
                                    <h6 class="sub-title" data-animation="fadeInUp" data-delay=".3s">Top World Networks</h6>
                                    <h1 class="title" data-animation="fadeInUp" data-delay=".5s">Complete IT Solutions
                                        <span>for the Modern Business</span>
                                    </h1>
                                    <p class="banner1">From network security and hardware to web services and IT outsourcing – we provide end-to-end support so you can focus on your core business.</p>
                                    <a class="btn-one" data-animation="fadeInUp" data-delay=".8s" href="{{ route('contact') }}">Contact us</a>
                                </div>
                            </div>
                        </div>
